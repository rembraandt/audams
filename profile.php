...
<head>
    ...
    <title>Profil - SMAN 2 Batu</title>
...
<body>
    ...
    <main class="profile-container">
        <section class="profile-hero">
            <h1>PROFIL SMAN 2 BATU</h1>
            <p>Mewujudkan peserta didik berkarakter, berprestasi, dan berwawasan global.</p>
        </section>
        ...
        <section class="profile-content">
            ...
            <div class="profile-card">
                <h2>Misi</h2>
                <ul>
                    <li>Menanamkan nilai-nilai keimanan dan ketaqwaan melalui pembelajaran dan kegiatan keagamaan di sekolah.</li>
                    <li>Menciptakan suasana pergaulan yang saling menghormati antarwarga sekolah, penuh toleransi dan menghargai keberagaman serta menghindari terjadinya perundungan.</li>
                    <li>Mewujudkan pelajar Indonesia yang mampu mempertahankan budaya luhur, kearifan lokal, berfikiran terbuka dalam berinteraksi dengan budaya lain.</li>
                    <li>Menanamkan nilai-nilai luhur bangsa yang berfalsafah kepada kejujuran, kedisiplinan, semangat berbagi dan gotong royong serta kebersamaan.</li>
                    <li>Melaksanakan pembelajaran yang berorientasi pada peserta didik.</li>
                </ul>
            </div>

            <div class="profile-card">
                <h2>Sejarah</h2>
                <p>SMA Negeri 2 Batu merupakan salah satu SMA Negeri di Kota Batu, berlokasi di dekat Mapolres Kota Batu dan Gedung DPRD Kota Batu, yaitu di Jalan Hasanudin 01 Junrejo Kota Batu. Sekolah ini berdiri dan mulai beroperasi pada tahun 1997 dibawah kepemimpinan Drs. Suratno sebagai Pejabat Sementara Kepala Sekolah. Pada saat itu SMA Negeri 2 Batu belum memiliki gedung sendiri, masih harus bergabung dengan SMA Negeri 01 Batu.
