...
<head>
    ...
    <title>Kesiswaan - SMAN 2 Batu</title>
...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a class="active" href="kesiswaan.php">KESISWAAN</a></li>
    ...
    <section class="hero">
        <h1>Kesiswaan</h1>
        <p>Informasi kegiatan, ekstrakurikuler, dan prestasi siswa SMAN 2 Batu.</p>
    </section>
    ...
    <main class="container">
        ...
        <div class="card">
            <h2>Prestasi</h2>
            <p>Siswa SMAN 2 Batu berhasil meraih juara 1 lomba debat bahasa Inggris tingkat provinsi.</p>
        </div>
    </main>
