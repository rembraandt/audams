...
<head>
    <meta charset="UTF-8">
    <title>Kurikulum - SMAN 2 Batu</title>
...
<body>
    ...
    <section class="hero">
        <h1>Kurikulum</h1>
        <p>Struktur kurikulum dan program pembelajaran di SMAN 2 Batu.</p>
    </section>

    <main class="container">
        <div class="card">
            <h2>Kurikulum Merdeka</h2>
            <p>Sekolah menerapkan Kurikulum Merdeka dengan fokus pada Profil Pelajar Pancasila.</p>
        </div>
        ...
        <div class="card">
            ...
            <ul>
                ...
                <li>Program Lingkungan Sekolah Hijau</li>
                <li>Kelas Riset dan Inovasi</li>
            </ul>
        </div>
    </main>
